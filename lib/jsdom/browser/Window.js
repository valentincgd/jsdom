...
function Window(options) {
  ...
  define(this, {
    ...
    scrollY: 0,
    screen: {
      availHeight: randomHeight - 46, availLeft: 0, availTop: 0, availWidth: randomWidth, colorDepth: 24, height: randomHeight, width: randomWidth, isExtended: false, orientation: { type: "landscape-primary" }
    },
